...
public abstract class BaseConfigurationFactoryTest {
    ...
    public void loadsValidConfigFiles() throws Exception {
        ...
        assertThat(configMap.get("Grpc.port")).isEqualTo(50051);
        assertThat(configMap.get("Dashboard.port")).isEqualTo(9999);
        assertThat(configMap.get("Dashboard.workers")).isEqualTo(30);
    }
