...
import com.flipkart.grpc.jexpress.service.HudsonService;
...
//        bind(BindableService.class).annotatedWith(Names.named("SampleService")).to(SampleService.class);
        bind(BindableService.class).annotatedWith(Names.named("HudsonService")).to(HudsonService.class);
        bind(Filter.class).annotatedWith(Names.named("GeHudsonLoggingFilter")).to(GetHudsonLoggingFilter.class);
