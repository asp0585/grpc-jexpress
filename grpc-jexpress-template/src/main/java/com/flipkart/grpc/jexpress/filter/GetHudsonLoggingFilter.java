...
@Named("GeHudsonLoggingFilter")
public class GetHudsonLoggingFilter implements Filter<IteratorRequest, IteratorResponse>, Logging {

    @Override
    public void doProcessRequest(IteratorRequest request) {
    ...
    @Override
    public void doProcessResponse(IteratorResponse response) {
        info("Response:");
    }
